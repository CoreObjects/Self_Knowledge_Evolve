...
CONSTRAINTS = [
    ...
    ("Concept",             "concept_id"),
    ("Entity",              "entity_id"),
    # Five-layer semantic structure node types
...
INDEXES = [
    ...
    ("OntologyNode",        "knowledge_layer"),
    ("MechanismNode",       "domain"),
    ("MechanismNode",       "lifecycle_state"),
    ("MethodNode",          "domain"),
    ("MethodNode",          "lifecycle_state"),
    ("ConditionRuleNode",   "domain"),
    ("ConditionRuleNode",   "lifecycle_state"),
    ("ScenarioPatternNode", "domain"),
    ("ScenarioPatternNode", "lifecycle_state"),
